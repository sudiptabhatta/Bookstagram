          ...
          <Row>
            ...
            <Col align="center">
              {isLoading ? (
                ...
                <button onClick={handleMoreClick} type="button" className="inline-flex items-center px-4 py-2 font-semibold leading-6 text-sm shadow rounded-md text-white bg-indigo-500 hover:bg-indigo-400 transition ease-in-out duration-150 cursor-not-allowed" disabled="">
                  Load More
                </button>
              )}
            </Col>
